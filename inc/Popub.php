...
class Popub
{
    ...
    public function action()
    {
        if( Web::method() === 'POST' && Web::isSetRequest('action') )
        {
            ...
            {
                $model = $admin_posts[ $action ];
                add_action( "admin_post_{$action}", $model );
            }
        }
    ...
    public function enqueueFrontAssets()
    {
        ...
        wp_enqueue_script('fancyapps_js', 'https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js', ['cdn_jquery_js'], '3.5.7', true);
    }
